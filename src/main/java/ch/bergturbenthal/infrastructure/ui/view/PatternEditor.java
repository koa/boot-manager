...
public class PatternEditor extends CustomComponent implements View {
  public PatternEditor(final StateService stateService,
    ...
    comboBox.addValueChangeListener(event -> {
      ...
      if (event.isUserOriginated() && !currentText.equals(originalContent.get())) {
        ...
        window.setContent(new VerticalLayout(questionLabel,
                                             new HorizontalLayout(cancelButton, ignoreButton, saveButton)));
        window.center();
    ...
    final VerticalLayout mainLayout = new VerticalLayout(comboBox,
                                                         contentArea,
